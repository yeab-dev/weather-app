      ...
      builder: (context, state) {
        return Scaffold(
          ...
          body: switch (state.status) {
            ...
            WeatherStatus.success => Builder(builder: (context) {
                String? locationName = state.currentWeather?.location;
                return SizedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(
                          height: MediaQuery.sizeOf(context).height * 0.02),
                      WeatherType(
                          state.dailyWeather?.weatherType[0].formattedName),
                      SizedBox(
                      ...
                      MoreInfoCard(
                        ...
                        relativeHumidity:
                            state.currentWeather?.relativeHumidity,
